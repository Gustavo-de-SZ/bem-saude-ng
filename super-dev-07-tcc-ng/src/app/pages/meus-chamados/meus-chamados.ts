    ...
    <div class="tcc-page-wrapper tcc-fade-in">
      <header class="tcc-page-header">
        <div class="tcc-header-title-group">
          ...
          <p class="tcc-subtitle">Histórico e status dos seus chamados</p>
        </div>
          ...
          <div class="tcc-form-card">
            <div class="tcc-chamado-item">
              ...
              <div class="tcc-chamado-actions">
                <span class="tcc-badge" [class]="statusBadgeClass(chamado.status)">{{ formatStatus(chamado.status) }}</span>
