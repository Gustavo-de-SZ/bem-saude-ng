        ...
        <div class="tcc-client-card" (click)="openDetails(cliente)">
          ...
          <div class="tcc-client-stats">
            <div class="tcc-mini-stat">
              <span>Ativos</span>
              <strong>{{ cliente.servicos_ativos !== undefined ? cliente.servicos_ativos : cliente.servicosAtivos }}</strong>
            </div>
            <div class="tcc-mini-stat">
              <span>Concluídos</span>
              <strong>{{ cliente.servicos_concluidos !== undefined ? cliente.servicos_concluidos : cliente.servicosConcluidos }}</strong>
            </div>
          </div>
